    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status_type', models.CharField(choices=[('new', 'Новый заказ'), ('in_progress', 'Заказ находится в обработке'), ('is_ready', 'Заказ готов'), ('completed', 'Заказ получен')], max_length=100, null=True, verbose_name='Обработчик заказа')),
                ('buying_type', models.CharField(choices=[('self', 'Самовывоз'), ('delivery', 'Доставка')], default='new', max_length=100, null=True, verbose_name='Статус доставки')),
                ('comment', models.TextField(blank=True, null=True, verbose_name='Комментарий к заказу')),
                ('owner', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL, verbose_name='Покупатель')),
                ('pies_order', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='pies_app.pies')),
            ],
        ),
    ]
