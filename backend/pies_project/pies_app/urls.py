...
urlpatterns = [
    ...
    path("orders/", views.orderListView.as_view()),#create, delete, list +
    path("basket/", views.basketListView.as_view()),#create, update, delete +
   ...
   # path("basket/get/<int:pk>/", views.basketListView.as_view()),
    path("addBasket/", views.addBasket.as_view()),
    path("basketUpdate/<int:pk>/", views.basketUpdateView.as_view()),
    path("basketDestroy/<int:pk>/", views.basketDestroyView.as_view()),
    ...
    path("oneBasket/<int:pk>/", views.basketRetrieveView.as_view()),
